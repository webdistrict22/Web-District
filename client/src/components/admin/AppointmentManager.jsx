    ...
    <div className="grid gap-5">
      <Card className="p-6 md:p-8">
        <div className="flex flex-col justify-between gap-5 xl:flex-row xl:items-end">
          ...
          <Button to="/admin/slots" variant="secondary">
            Manage slots
          </Button>
        </div>
      </Card>
...
function AdminAppointmentCard({
    ...
    <Card className="overflow-hidden">
      <div className="grid gap-0 xl:grid-cols-[1fr_420px]">
        <div className="p-6">
          ...
          <p className="mt-5 leading-8 text-[#CBD5E1]">{appointment.topic}</p>
  ...
  <button
    ...
    disabled={isDeleting}
    className="inline-flex items-center justify-center gap-2 rounded-2xl border border-red-400/20 bg-red-400/10 px-5 py-3 text-sm font-semibold text-red-200 transition hover:border-red-400/40 disabled:cursor-not-allowed disabled:opacity-60 sm:col-span-2"
  >
    <Trash2 size={17} />
